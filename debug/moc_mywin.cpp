...
QT_MOC_LITERAL(1, 6, 10), // "save_image"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 16) // "select_Old_image"

    },
    "MyWin\0save_image\0\0select_Old_image"
};
...
void MyWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->save_image(); break;
        case 1: _t->select_Old_image(); break;
        default: ;
        }
        ...
        {
            using _t = void (MyWin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWin::save_image)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyWin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWin::select_Old_image)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyWin::save_image()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyWin::select_Old_image()
{
